    ...
    <div id="contacto" >
      <div className={classes.footer}>
        ...
        <div className={classes.infoContact}>
          ...
          <p>Lomas de zamora - ing Budge - Av Olimpo</p>
        </div>
        ...
        <div className={classes.socialContact}>
          <Link href={'www.google.com.ar'} ><Image src={'/images/social/facebook.png'} height={50} width={50} /> </Link>
          <Link href={'www.google.com.ar'} ><Image src={'/images/social/instagram.png'} height={50} width={50} /> </Link>
          <Link href={'www.google.com.ar'} ><Image src={'/images/social/tiktok.png'} height={50} width={50} /> </Link>
        </div>
      </div>
